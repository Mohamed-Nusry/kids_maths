...
export default {
  ...
  methods: {
    ...
    loadDataToSystem(){
      ...
      this.playMode = 'Subtraction (-)';
      this.level = JSON.parse(localStorage.getItem("userData")).subtraction.level;
      this.gameMode = JSON.parse(localStorage.getItem("userData")).subtraction.mode;
    //  this.toffeeCount = JSON.parse(localStorage.getItem("userData")).subtraction.toffee;
      this.xpPoints = JSON.parse(localStorage.getItem("userData")).subtraction.xp;
    ...
    addMarks(){
      ...
      if(modifyUserData.subtraction.level > 0 && modifyUserData.subtraction.level < 10){
        ...
        modifyUserData.subtraction.mode = 'Beginner';
      }else{

        if(modifyUserData.subtraction.level >= 10 && modifyUserData.subtraction.level < 25){
          randomXp = Math.floor(Math.random() * (25-10+1)) + 10;
          modifyUserData.subtraction.mode = 'Easy';
          ...
          if(modifyUserData.subtraction.level >= 25 && modifyUserData.subtraction.level < 50){
            ...
            modifyUserData.subtraction.mode = 'Medium';
            ...
            if(modifyUserData.subtraction.level >= 50 && modifyUserData.subtraction.level < 100){
              ...
              modifyUserData.subtraction.mode = 'Pro';

            }else{

              randomXp = Math.floor(Math.random() * (5-2+1)) + 2;
              modifyUserData.subtraction.mode = 'Champion';
      ...
      modifyUserData.subtraction.xp =  modifyUserData.subtraction.xp + randomXp
    ...
    increaseLevel(){
      ...
      if (modifyUserData.subtraction.xp > modifyUserData.subtraction.recentxp) {
        var differnceXp = modifyUserData.subtraction.xp - modifyUserData.subtraction.recentxp;
        if(differnceXp >= 100){

          modifyUserData.subtraction.recentxp =  modifyUserData.subtraction.xp;
          modifyUserData.subtraction.level =  modifyUserData.subtraction.level + 1;
